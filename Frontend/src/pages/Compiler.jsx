...
const Compiler = () => {
  ...
  useEffect(() => {
    const fetchProblem = async () => {
      try {
        const res = await axios.get(`https://rishuharsh.xyz/problems/${id}`);
        setProblem(res.data);
      } catch (error) {
  ...
  const handleRun = async () => {
    try {
      const res = await axios.post('https://rishuharsh.xyz/compiler/run', {
        language,
        code,
        input: userInput,
      });
  ...
  const handleSubmit = async () => {
    try {
      const res = await axios.post('https://rishuharsh.xyz/compiler/submit', {
        code,
        language,
        input: userInput,
        problemId: id,
